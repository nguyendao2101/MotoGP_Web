...
class RidersAndTeamsTeamsMoto3ViewModel extends GetxController {
  final DatabaseReference _databaseReference = FirebaseDatabase.instance.ref();
  RxList<Map<String, dynamic>> ridersListMoto3 = <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> ridersListMoto3Substitute =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> ridersListMoto3WildCardsAndTestRiders =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> teamsMoto3 = <Map<String, dynamic>>[].obs;
...
// Fetch MotoGP riders' data and store in ridersMap
  ...
  Future<void> fetchTeamsMoto3() async {
    DatabaseReference resultsRef =
        _databaseReference.child('Riders&Team/Teams/Moto3');
