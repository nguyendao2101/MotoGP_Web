...
class RidersAndTeamsTeamsMotoeViewModel extends GetxController {
  final DatabaseReference _databaseReference = FirebaseDatabase.instance.ref();
  RxList<Map<String, dynamic>> ridersListMotoe = <Map<String, dynamic>>[].obs;

  RxList<Map<String, dynamic>> teamsMotoe = <Map<String, dynamic>>[].obs;
    ...
    officialRidersRef.once().then((DatabaseEvent event) {
      ...
      if (snapshot.value != null) {
        ...
        ridersMapData.forEach((key, value) {
          ...
          ridersListMotoe.add(riderData);
        });
      }
    });
  }

  Future<void> fetchTeamsMotoe() async {
    DatabaseReference resultsRef =
        _databaseReference.child('Riders&Team/Teams/MotoE');
