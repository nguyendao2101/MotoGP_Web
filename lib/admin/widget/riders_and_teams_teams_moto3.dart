// ignore_for_file: avoid_print, use_build_context_synchronously, non_constant_identifier_names, no_leading_underscores_for_local_identifiers
...
class _RidersAndTeamsTeamsMoto3State extends State<RidersAndTeamsTeamsMoto3> {
  ...
  void _showInputDialog(BuildContext context,
      RidersAndTeamsTeamsMoto3ViewModel controller, String path) {
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  await newEntryRef.set(data).then((_) async {
                    ...
                    controller.teamsMoto3.value = updatedData;
                  }).catchError((error) {
