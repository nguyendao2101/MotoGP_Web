                          ...
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controller,
                                  'Riders&Team/Riders/Moto2/Official');
                            },
                            child: Padding(
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controller,
                                  'Riders&Team/Riders/Moto2/WildcardsAndTestRiders');
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(vertical: 20),
                              child: Image.asset(
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controller,
                                  'Riders&Team/Riders/Moto2/Substitute');
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(vertical: 20),
                              child: Image.asset(
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  await newEntryRef.set(data).then((_) async {
                    ...
                    controller.ridersListMoto2Official.value = updatedData;
                  }).catchError((error) {
