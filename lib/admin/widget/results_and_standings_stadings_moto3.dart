...
class _ResultsAndStandingsStadingsMoto3State
  ...
  final controllerRiders = Get.put(ResultAndStadingsStandingsMoto3ViewModel());
  @override
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _grandsPrixMonth('Moto3 Standings'),
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controllerRiders,
                                  'Results&Standings/Standings/2024/RidersChampionship/Moto3ADD');
                            },
                            child: Padding(
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _grandsPrixMonth('Moto3 Standings Add'),
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
              ...
              Obx(() {
                if (controllerRiders.standingsMoto3Add.isEmpty) {
                  return const SliverFillRemaining(
                      child: Center(child: Text('No data added yet')));
                } else {
                  return ResultsAndStandingsStadingsListView(
                    controller: controllerRiders,
                    listDS: controllerRiders.standingsMoto3Add,
                  );
                }
              }),
            ],
  ...
  void _showInputDialog(BuildContext context,
      ResultAndStadingsStandingsMoto3ViewModel controller, String path) {
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  await newEntryRef.set(data).then((_) async {
                    ...
                    controller.standingsMoto3Add.value = updatedData;
                  }).catchError((error) {
  ...
  Future<void> _refreshData() async {
    await Future.wait([
      ...
      controllerRiders.fetchRidersStandingsMoto3Add(),
    ]);
  }
}
