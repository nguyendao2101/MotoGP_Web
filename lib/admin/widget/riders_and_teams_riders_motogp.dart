                          ...
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controller,
                                  'Riders&Team/Riders/MotoGP/Official');
                            },
                            child: Padding(
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controller,
                                  'Riders&Team/Riders/MotoGP/WildcardsAndTestRiders');
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(vertical: 20),
                              child: Image.asset(
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controller,
                                  'Riders&Team/Riders/MotoGP/Substitute');
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(vertical: 20),
                              child: Image.asset(
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  await newEntryRef.set(data).then((_) async {
                    ...
                    controller.ridersListMotoGP.value = updatedData;
                  }).catchError((error) {
