...
class _ResultsAndStandingsStadingsMotoeState
  ...
  final controllerRiders = Get.put(ResultAndStadingsStandingsMotoeViewModel());
  @override
                          ...
                          InkWell(
                            onTap: () {
                              _showInputDialog(context, controllerRiders,
                                  'Results&Standings/Standings/2024/RidersChampionship/MotoEADD');
                            },
                            child: Padding(
  ...
  void _showInputDialog(BuildContext context,
      ResultAndStadingsStandingsMotoeViewModel controller, String path) {
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  await newEntryRef.set(data).then((_) async {
                    ...
                    controller.standingsMotoEAdd.value = updatedData;
                  }).catchError((error) {
